...
/**
 * Ένα αεροσκάφος εχει δύο δεξαμενές.
 * Άν μία δεξαμενή έχει λιγότερο από 1/4 καύσιμα τότε ανάβει πορτοκαλί
 * σήμα, ενώ αν και οι δύο δεξαμενες έχουν <1/4 τότε ανάβει κόκκινο σήμα.
 * Ο πιλότος (χρήστης) δίνει true ή  false ανάλογα αν το tank  1/4 ή όχι.
 */
